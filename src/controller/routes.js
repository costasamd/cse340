...
import {
    ...
    processLoginForm, processLogout, showDashboard, requireLogin, requireRole, showAllUsers, displayProjectsByUser,
    removeUserFromProject, assignUserToThisProject
} from './users.js';
...
router.get('/project/:id', requireLogin, showProjectDatailsPage);
...
router.get('/dashboard', requireLogin, displayProjectsByUser ,showDashboard);                
...
router.post('/projects/remove/:projectId', requireLogin, removeUserFromProject);
router.post('/projects/assign/:projectId', requireLogin, assignUserToThisProject);
